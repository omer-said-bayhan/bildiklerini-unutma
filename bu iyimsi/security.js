...
/**
 * LocalStorage anahtarı (oturumluk)
 * Her session için yeni anahtar üretir (uygulama kapandığında sıfırlanır)
 */
const STORAGE_KEY = (() => {
...
function secureSetItem(key, value) {
  const encrypted = simpleEncrypt(JSON.stringify(value), STORAGE_KEY);

...
// PBKDF2 + Salt ile güvenli şifre hash'leme
...
// Mevcut hash ile şifre doğrulama (eski SHA-256 formatı ile de uyumlu)
async function verifyPassword(password, storedHash) {
    if (storedHash.startsWith('pbkdf2:')) {
        // Yeni PBKDF2 formatı: pbkdf2:salt:hash
        ...
        // Eski SHA-256 formatı (geriye uyumluluk)
        const encoder = new TextEncoder();
